...
-- Weapon type constants (matching C++ WeaponType enum)
WEAPON_NONE = 0
WEAPON_SWORD = 1
WEAPON_CLUB = 2
WEAPON_AXE = 3
...
WEAPON_CROSSBOW = 10
WEAPON_THROW = 11
WEAPON_WANDROD = 6  -- Same as WEAPON_WAND
...
UnknownCategories = {
	[WEAPON_AXE] 	  = 17, -- MarketCategory.Axes
	[WEAPON_BOW]      = 19, -- MarketCategory.DistanceWeapons
	[WEAPON_CLUB]     = 18, -- MarketCategory.Clubs
	[WEAPON_FIST]     = 27, -- MarketCategory.FistWeapons
	[WEAPON_SWORD]    = 20, -- MarketCategory.Swords
	[WEAPON_THROW]    = 19, -- MarketCategory.DistanceWeapons
	[WEAPON_WANDROD]  = 21, -- MarketCategory.WandsRods
	[WEAPON_CROSSBOW] = 19  -- MarketCategory.DistanceWeapons
}